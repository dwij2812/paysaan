...
class Transaction:
    ...
    def __init__(self, sender_address, sender_private_key, recipient_address, value, description):
...
def generate_transaction():
	...
	transaction = Transaction(sender_address, sender_private_key, recipient_address, value, description)
